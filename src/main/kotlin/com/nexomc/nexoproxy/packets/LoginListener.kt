 ...
 */
class LoginListener(val config: NexoConfig, val logger: Logger) : AwaitingEventExecutor<PlayerFinishedConfigurationEvent> {

    override fun executeAsync(event: PlayerFinishedConfigurationEvent): EventTask? {
